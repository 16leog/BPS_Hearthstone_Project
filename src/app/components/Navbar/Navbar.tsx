...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {toggle && (
        <div className="sm:hidden animate-open-menu fixed top-20 bg-navbarColor w-full h-[90vh] text-4xl flex flex-col items-center justify-center gap-24 origin-top left-0 z-30">
          <button
